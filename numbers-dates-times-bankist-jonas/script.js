...
console.log(+(2.345).toFixed(2));
console.log(+(234.23432).toFixed(3));
...
console.log(2 ** 53 + 3);
console.log(2 ** 53 + 4);
console.log(65464564546545464546465465454646n);
console.log(BigInt(65464564546545464546465465454646));
// Operations
